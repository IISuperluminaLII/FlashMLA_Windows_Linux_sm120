...
def _load_flash_mla_extension() -> ModuleType:
    ...
    if prefer_arch:
        ...
        if prefer_arch == "sm120":
            candidates.append(("flash_mla_agent_a.cuda_sm120", "sm120"))
        elif prefer_arch == "sm100":
            candidates.append(("flash_mla_agent_a.cuda_sm100", "sm100"))
        elif prefer_arch == "legacy":
            candidates.append(("flash_mla_agent_a.cuda", "legacy"))

    candidates.extend(
        [
            ("flash_mla_agent_a.cuda_sm120", "sm120"),
            ("flash_mla_agent_a.cuda_sm100", "sm100"),
            ("flash_mla_agent_a.cuda", "legacy"),
        ]
    )
